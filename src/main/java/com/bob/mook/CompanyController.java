...
public class CompanyController {
	...
	@RequestMapping(value = "/inner/company/result/{farm_info_index}/{form_count}", method = RequestMethod.GET)
	...
	@ResponseBody
	@RequestMapping(value = "/inner/company/admin/api/farm-id-list", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value = "/inner/company/admin/api/scale", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value = "/inner/company/admin/api/farm-info-by-farm-id/{farmId}", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value = "/inner/company/api/result/{scale}/{farm_info_index}/{form_count}", method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value = "/inner/company/api/result/{farm_info_index}", method = RequestMethod.POST)
